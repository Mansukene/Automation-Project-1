...
Assignment 2:
 ...
 2. Replace text ‘p455p455’ in the first test with your own chosen password (2 places) - passwords should match
...
describe('This is first test suite, Maia-Liisa Voolaid', () => {
    it('User can submit data only when valid mandatory values are added', () => {
        //today's date is April 26th, 2024
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        cy.get('#firstName').type('Maia')
    ...
    it('User can use only same both first and validation passwords', () => {
        ...
        cy.get('input[name="password"]').type('p455p455')
        cy.get('[name="confirm"]').type('p455p455123')
